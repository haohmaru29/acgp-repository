...
<%
	...
	if (!codEje.equals("")){
		Seguridad.ValidaUsuario objVar = new Seguridad.ValidaUsuario();
		int rev = 0;
		...
		{
			if (rev==-1)
				msgErr = com.Errores.getDescription("ERR.USUARIOS.INFO");
			if (rev==-2)
			{
				StrUsuario="";
				msgErr = com.Errores.getDescription("ERR.LOGIN.USUARIO");
			}
			if (rev==-3)
				msgErr = com.Errores.getDescription("ERR.LOGIN.CLAVE");	
			if (rev==-4)
				msgErr = com.Errores.getDescription("ERR.GENERAL.BASE");	
			if (rev==-5)
				msgErr = com.Errores.getDescription("ERR.USUARIOS.ACCE");			
