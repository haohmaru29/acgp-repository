...
<html>
  ...
  <body  >
  		<iframe width="900px" height="717px" src="pdfengine?numeroOperacion=<%=numeroOperacion %>&fechaRemesa=<%=fechaRemesa %>&nombreRemesa=<%=nombreRemesa %>&montoRemesa=<%=montoRemesa %>" type="application/pdf" id="pdfTest">
        </iframe>
  </body>
</html>