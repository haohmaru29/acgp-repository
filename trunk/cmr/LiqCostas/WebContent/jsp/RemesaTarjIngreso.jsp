			     ...
			     {id: 'rut' , header: "Rut Cliente" , width :150, sortable:false, editable:true, editor:{type:"text",
			     	...
			     	{					     		
							...
							else
							{
									...
									mygrid.NroCuentasCliente(value,document.getElementById("ABOGADO").value,'<%=Grupo%>');
...
<INPUT TYPE="HIDDEN" id="TIPOPRODFORMULARIO"  NAME="TIPOPRODFORMULARIO" VALUE="0">	
 <% 
  ...
  <tr>
   <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
       	<tr><td align="CENTER" class="titulo"><%=Titulo%> REMESAS ABOGADO CRÉDITO Y TC</td></tr>
        <tr>
          <td align="center">
