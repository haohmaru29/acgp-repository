...
public class OidBasicWebServiceSoapHttp_validateUserPassword_ReqS_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable {
    ...
    public OidBasicWebServiceSoapHttp_validateUserPassword_ReqS_LiteralSerializer(QName type) {
        this(type,  false);
    }
    
    public OidBasicWebServiceSoapHttp_validateUserPassword_ReqS_LiteralSerializer(QName type, boolean encodeType) {
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        cl.bicevida.core.model.services.ws.proxy.oid.runtime.OidBasicWebServiceSoapHttp_validateUserPassword_ReqS instance = new cl.bicevida.core.model.services.ws.proxy.oid.runtime.OidBasicWebServiceSoapHttp_validateUserPassword_ReqS();
        ...
        elementName = reader.getName();
        if (reader.getState() == XMLReader.START) {
            if ( matchQName(elementName, ns1_password_QNAME) ) {
                myns2_string__java_lang_String_String_Serializer.setNullable( false );
                ...
                throw new DeserializationException("literal.unexpectedElementName", new java.lang.Object[] { ns1_password_QNAME, reader.getName() }, DeserializationException.FAULT_CODE_CLIENT);
            }
        }
        else {
            throw new DeserializationException("literal.expectedElementName", reader.getName().toString(), DeserializationException.FAULT_CODE_CLIENT );
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        cl.bicevida.core.model.services.ws.proxy.oid.runtime.OidBasicWebServiceSoapHttp_validateUserPassword_ReqS instance = (cl.bicevida.core.model.services.ws.proxy.oid.runtime.OidBasicWebServiceSoapHttp_validateUserPassword_ReqS)obj;
