...
public class RetListaTipoCalle implements java.io.Serializable {
    protected cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.TipoCalleModel[] listaTipoCalle;
    protected java.lang.String mensajeRetorno;
    protected java.lang.String codigoRetorno;
    
    public RetListaTipoCalle() {
    }
    
    public cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.TipoCalleModel[] getListaTipoCalle() {
        return listaTipoCalle;
    }
    
    public void setListaTipoCalle(cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.TipoCalleModel[] listaTipoCalle) {
