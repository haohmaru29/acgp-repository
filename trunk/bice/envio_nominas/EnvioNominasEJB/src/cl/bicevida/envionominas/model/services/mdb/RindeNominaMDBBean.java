...
@MessageDriven( messageListenerInterface = MessageListener.class, activationConfig = { @ActivationConfigProperty( propertyName = "connectionFactoryJndiName", propertyValue = "jms/EnvioNominasQueueConnectionFactory" )
            ...
            , @ActivationConfigProperty( propertyName = "destinationName", propertyValue = "jms/RINDE_NOMINA_Q" )
            } )
public class RindeNominaMDBBean implements MessageListener {
    @EJB
    ...
    public void onMessage( Message message ) {
        ...
        if ( message instanceof TextMessage ) {
            ...
            try {
                envioNominasEJB.ejecutarRendicionPagoProcesoEnvioNomina( _type );
