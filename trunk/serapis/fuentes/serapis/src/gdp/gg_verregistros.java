...
// Source File Name:   gg_verregistros.java
...
public class gg_verregistros extends HttpServlet
{

    public gg_verregistros()
    {
        ...
        throws IOException, ServletException
    {
        ...
        if(s17 != null && s17.length() > 0)
        {
            ...
            printwriter.println("<tr><td width='80%' colspan='4' class='texttituloarea' align='center'>Registros Gr\341ficos de Gesti\363n</td></tr>");
            rs = new Vector();
            String s = "SELECT grafico_gestion from gdc.gestion_procesos";
            ...
            if(rs.size() > 0)
            {
                ...
                if(rs.size() > 0)
                {
                    ...
                    {
                        printwriter.println("<tr>");
                        printwriter.println("<td class='textdesttabla' align='left' colspan='3'>No se encontraron registros de Gr\341ficos de Gesti\363n.</td>");
                        printwriter.println("</tr>");
                    }
                } else
                {
