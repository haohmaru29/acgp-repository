...
// Source File Name:   uploadfichero.java
...
public class uploadfichero extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        if(UsuarioReg != null && UsuarioReg.length() > 0)
        {
            ...
            printwriter.println("<form name='publica' method='POST' enctype='multipart/form-data' action=''>");
            if(ObtieneRutas() == 1)
            {
    ...
    public boolean procesaFicheros(HttpServletRequest httpservletrequest, PrintWriter printwriter)
    {
        ...
        Integer integer4 = new Integer(0x131c9a5);
        ...
        try
        {
            ...
            String s6 = "select count(*) from sad.documentos where tipodoc = '" + tipodocumentos + "' and ";
            ...
            if(integer.intValue() == 0)
            {
                ...
                File file = new File(RutaDocumentos + "sad\\documentos\\" + tipoprocesos + "\\" + s5);
                fileitem.write(file);
                ...
                if(i == 1)
                {
                    String s8 = "select id from sad.documentos where tipodoc = '" + tipodocumentos + "'";
