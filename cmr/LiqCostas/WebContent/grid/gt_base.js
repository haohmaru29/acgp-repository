...
Sigma.Utils={
	...
	createSelect : function(map, defaultValue,opt, selectEl){
			...
			Sigma.$each(map,
				function(text,value){
					//alert("createSelect->text=" + text);
					//alert("createSelect->value=" + value);
					//alert("createSelect->defaultValue=" + defaultValue);
					//alert("createSelect->Sigma.$chk(defaultValue)=" + Sigma.$chk(defaultValue));
					var op=Sigma.$e("option",{'value' : value ,'text':''+text, innerHTML :text});
					if (Sigma.$chk(defaultValue) && value==defaultValue){
						//alert("createSelect->selecciono");
						op.selected=true;
					}
