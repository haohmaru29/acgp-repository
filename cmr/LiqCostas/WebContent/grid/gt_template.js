		...
		formIFrame : function(grid){
				...
				var ghtml=[
					 '<div class="gt-hidden" >',
						...
						'</form>',
						'<iframe src="black.html" id="'+gid+'_export_iframe"  name="'+gid+'_export_iframe" scrolling="no" style="width:0px;height:0px;" width="0" height="0" border="0" frameborder="0" >',
						'</iframe>',
					 '</div>'
				];
				//alert("llego aca formIFrame");
				return ghtml.join('\n');
		},
