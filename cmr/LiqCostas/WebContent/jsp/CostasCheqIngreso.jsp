...
<jsp:include page="principal.jsp" flush="false"/>	
  ...
  <SCRIPT LANGUAGE="JavaScript">		
		...
		colsOption = [
			     ...
			     {id: 'cheque' , header: "N° Unico" , width :300, sortable:false, editable:true,
			      editor : { type :"text" ,
			      validator : function(value,record,colObj,grid) {	
  ...
  <tr>
   <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
       	<tr><td align="CENTER" class="titulo"><%=Titulo%> COSTAS PROCESALES CHEQUES PROTESTADOS</td></tr>
        <tr>
          <td align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablagris">
                 <tr>
		            ...
		            <td class="labelDos" width="8%"><input tabindex="3" id="TxtRutPrestador" name="TxtRutPrestador" maxlength="15" style="width: 100%" type="text" onblur="return SetearObjeto('');" onfocus="return SetearObjeto('TxtRutPrestador');" value="<%=RutPrestador%>"/></td>		            
						   
				</tr>				
				<tr>
		            <td class="labelUno" width="10%" >Código Abogado</td>
		            <td class="labelDos" width="10%"><input type="text" name="ABOGADO" id="ABOGADO" maxlength="10" tabindex="5" style="width: 100%;margin:auto;" value="<%=CodAbogado%>" onblur="return SetearObjeto('');" onfocus="return SetearObjeto('ABOGADO');"></td>	            
				...
				<tr>
		            ...
		            <td class="labelDos" width="8%"><input tabindex="10" id="TxtMonto" name="TxtMonto" style="width: 100%"  type="text" maxlength="9" size="15" value="<%=MontoStr%>" onblur="return SetearObjeto('');" onfocus="return SetearObjeto('TxtMonto');"/></td>			            
...
<SCRIPT LANGUAGE="JavaScript">		
	...
	valJS.MaskInput(f.TxtNumDocum,'9999999999');		
