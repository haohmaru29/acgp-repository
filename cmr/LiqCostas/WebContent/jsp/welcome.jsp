		...
		<FORM METHOD="POST" NAME="FRMWELCOME">
		  ...
		  <br>
			<TABLE WIDTH="50%" height="200px" ALIGN="CENTER" BORDER="0" CELLPADDING="0" CELLSPACING="0" class="fondotabla">
				...
				<TR>
					<TD CLASS="clsbienvenida" ALIGN="CENTER">Bienvenidos al Sistema <%=Errores.getDescription("VAR.TITULO")%></TD>
				</TR>
				<TR>
					<TD class="labelUno" ALIGN="CENTER"><%=Errores.getDescription("VAR.COMPAÑIA")%></TD>
				</TR>
				<TR>
					<TD class="labelUno" ALIGN="CENTER"><%=Errores.getDescription("VAR.VERSION")%></TD>
				</TR>
				<TR>
					<TD class="labelUno" ALIGN="CENTER">&nbsp;</TD>
				</TR>
