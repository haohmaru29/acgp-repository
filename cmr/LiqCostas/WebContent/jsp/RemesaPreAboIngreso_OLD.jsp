...
<jsp:include page="principal.jsp" flush="false"/>	
  ...
  <SCRIPT LANGUAGE="JavaScript">		
		...
		<% if (resAbogado.size()==0)
		   {%>
		   		arrAbogado[0]={codigo: "PA00801", sucursal: "PA00801", nombre: "Pre Abogado 801"};
		   <%}
		   else
		   {	
          ...
          <td align="center">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablagris">
				...
				<tr>
		            ...
		            <td class="labelUno" width="12%">Agencia</td>
			...
			<table width="262px" border="0" cellspacing="0" cellpadding="0" class="tablagris">
						<%if (IdEntrada.equals("") && Origen.equals("INGRESO")) // en ingreso
					  	{%>
							<tr>
							<td width="216px">&nbsp;</td>
						    <td width="46px" align="left"><a tabindex="14" href="#" onClick="JavaScript:GrabarRemesa(window.document.FRMINGRESOREM,event);" id="rollovergrabar" title="Grabar Liquidación"><span>grabar</span></a></td>
				        	</tr>	
			        	<%}
			        	else
			        	{
...
<SCRIPT LANGUAGE="JavaScript">		
	...
	f.TxtNomAbo.value=arrAbogado[0].nombre + ' - ' + arrAbogado[0].sucursal;
