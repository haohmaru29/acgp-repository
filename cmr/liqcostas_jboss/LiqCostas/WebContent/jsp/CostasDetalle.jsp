...
<%  
	...
	retD = objGeneral.ObtieneElemListaCosta("PROREMCP",resProducto);
	...
	if (IdEntrada.equals("INICIO") || IdEntrada.equals("VOLVERBUSQ") || IdEntrada.equals("LIMPIAR"))
	{
		if (FechaDesde.equals("")==false)
		{
			...
			if (Iret==2)
				sMensaje=Errores.getDescription("ERR.GENERAL.BASE");
			else
				if (resCosta.size()<=0 || resCosta.size()<=0)
					sMensaje=Errores.getDescription("ERR.RESUMEN.COSTA");
		}
	}
	else
	{
		...
		{
			dispatcher = getServletContext().getRequestDispatcher("/jsp/CostasDetalle.jsp");
...
<jsp:include page="principal.jsp" flush="false"/>	
  ...
  <SCRIPT LANGUAGE="JavaScript">		
		...
		{
			LimpiarCamposConsulta(obj,6);
			f.action = "CostasDetalle.jsp";
			f.target = "_self";
		...
		function ImprimirInforme()
 		{ 			 			
			document.FRMCONSULTACOS.action = "CostasImprimeDetalle.jsp";
  ...
  <tr>
    <td valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
   		<tr><td align="CENTER" class="titulo">DETALLE COSTAS PROCESALES</td></tr>
        <tr>
          <td align="center">
        	<DIV id=popCal 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablagris" align="center"> 				             
			   ...
			   <tr>  
		            ...
		            <td class="labelDos">
		            		<SELECT tabindex="4" NAME="CABOGADO" id="CABOGADO" class="select1" onblur="return SetearObjeto('');" onfocus="return SetearObjeto('');"></SELECT>
							<SCRIPT LANGUAGE="JavaScript">
		        ...
		        <tr>  
		            ...
		            <td class="labelDos">
		            		<SELECT tabindex="5" NAME="CPRODUCTO" id="CPRODUCTO" class="select1" onblur="return SetearObjeto('');" onfocus="return SetearObjeto('');"></SELECT>
							<SCRIPT LANGUAGE="JavaScript">
								valJS.LlenarLista(arrProducto,window.document.FRMCONSULTACOS.CPRODUCTO,"N","<%=CodProducto%>",""); 
							</SCRIPT>
		            </td> 
			...
			<table width="262px" border="0" cellspacing="0" cellpadding="0" class="tablagris">
			  <tr>
			  		<td width="124px"></td>
		            <td width="46px"><a tabindex="6" href="#" onClick="JavaScript:Limpiar(window.document.FRMCONSULTACOS);" id="rolloverlimpiar" title="Limpiar Datos"><span>limpiar</span></a></td>
			        <td width="46px"><a tabindex="7" href="#" onClick="JavaScript:ImprimirInforme();" id="rolloverimprimir" title="Imprimir Informe"><span>imprimir</span></a></td>
			        <td width="46px" align="left"><a tabindex="8" href="#" onClick="JavaScript:ConsultarCostas(window.document.FRMCONSULTACOS);" id="rolloverbuscar" title="Buscar"><span>buscar</span></a></td>
			  </tr> 	  
			</table>
			</div>    
			<br/>
			...
			<table width="100%" border=0 cellpadding="0" cellspacing="0">
					  <tr>
		           	  <td class="BORDEAZUL"><div style="width:230px">Producto</div></td>
		           	  <td class="BORDEAZUL"><div style="width:210px"">Rut Cliente</div></td>
		           	  <td class="BORDEAZUL"><div style="width:210px"">Nro Cheque</div></td>
		              <td class="BORDEAZUL"><div style="width:200px">Valor Costa</div></td>
		              <td class="BORDEAZUL"><div style="width:280px">Tipo Cargo</div></td>
		              </tr>				      
				   	  <%					   	
				   	  for(int i=0; i<resCosta.size(); i++) 
