...
public class RetListaComuna implements java.io.Serializable {
    protected java.lang.String mensajeRetorno;
    protected java.lang.String codigoRetorno;
    protected cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.ComunaModel[] listaComuna;
    
    public RetListaComuna() {
    }
    ...
    public cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.ComunaModel[] getListaComuna() {
        return listaComuna;
    }
    
    public void setListaComuna(cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.ComunaModel[] listaComuna) {
