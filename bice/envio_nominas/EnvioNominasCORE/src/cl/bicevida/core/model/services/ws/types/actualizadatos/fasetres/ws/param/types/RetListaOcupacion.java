...
public class RetListaOcupacion implements java.io.Serializable {
    protected java.lang.String mensajeRetorno;
    protected java.lang.String codigoRetorno;
    protected cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.OcupacionModel[] listaOcupacion;
    
    public RetListaOcupacion() {
    }
    ...
    public cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.OcupacionModel[] getListaOcupacion() {
        return listaOcupacion;
    }
    
    public void setListaOcupacion(cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.OcupacionModel[] listaOcupacion) {
