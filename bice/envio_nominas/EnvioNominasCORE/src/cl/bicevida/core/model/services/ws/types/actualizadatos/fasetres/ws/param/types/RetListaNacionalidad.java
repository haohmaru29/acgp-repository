...
public class RetListaNacionalidad implements java.io.Serializable {
    protected java.lang.String mensajeRetorno;
    protected java.lang.String codigoRetorno;
    protected cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.NacionalidadModel[] listaNacionalidad;
    
    public RetListaNacionalidad() {
    }
    ...
    public cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.NacionalidadModel[] getListaNacionalidad() {
        return listaNacionalidad;
    }
    
    public void setListaNacionalidad(cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.NacionalidadModel[] listaNacionalidad) {
