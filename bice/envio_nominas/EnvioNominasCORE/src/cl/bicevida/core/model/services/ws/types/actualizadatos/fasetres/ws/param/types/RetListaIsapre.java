...
public class RetListaIsapre implements java.io.Serializable {
    protected cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.IsapreModel[] listaIsapre;
    protected java.lang.String mensajeRetorno;
    protected java.lang.String codigoRetorno;
    
    public RetListaIsapre() {
    }
    
    public cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.IsapreModel[] getListaIsapre() {
        return listaIsapre;
    }
    
    public void setListaIsapre(cl.bicevida.core.model.services.ws.types.actualizadatos.fasetres.ws.param.types.IsapreModel[] listaIsapre) {
