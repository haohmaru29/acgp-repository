...
public class Application {
  ...
  private static final String jndi = "module.db.jndi";
  private static final String packageDB = "module.db.package";
  ...
  public String jndiDB() {
    return appProperties.getProperty( jndi ); 
  }
  
  public String packageDB() {
    return appProperties.getProperty( packageDB ); 
  }
