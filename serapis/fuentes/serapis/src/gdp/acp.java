...
public class acp extends HttpServlet
{
        ...
        throws IOException, ServletException
    {
        ...
        if(s != null && s.length() > 0)
        {
            ...
            printwriter.println("<form name='frmnc' action='acp.jsp' method='POST'>");
            printwriter.println("<table border='0' width='95%' align='center'>");
            printwriter.println("<tr><td align='center'  class='texttitulomayor'></td></tr>");
