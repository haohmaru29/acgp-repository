...
// Source File Name:   nc_procesamod.java
...
public class nc_procesamod extends HttpServlet
{

    public nc_procesamod()
    {
        ...
        throws IOException, ServletException
    {
        ...
        if(s4 != null && s4.length() > 0)
        {
            ...
            String s5 = httpservletrequest.getParameter("txtnombre");

            String s6 = (httpservletrequest.getParameter("CHK_REAL")!=null)?httpservletrequest.getParameter("CHK_REAL"):"N";
            String s7 = (httpservletrequest.getParameter("CHK_POTENCIAL")!=null)?httpservletrequest.getParameter("CHK_POTENCIAL"):"N";
            String s8 = (httpservletrequest.getParameter("CHK_PROVEEDOR")!=null)?httpservletrequest.getParameter("CHK_PROVEEDOR"):"N";
            String s9 = (httpservletrequest.getParameter("CHK_PROCESO")!=null)?httpservletrequest.getParameter("CHK_PROCESO"):"N";
            String s10 = (httpservletrequest.getParameter("CHK_PRODUCTO")!=null)?httpservletrequest.getParameter("CHK_PRODUCTO"):"N";
            String s11 = (httpservletrequest.getParameter("CHK_INSUMO")!=null)?httpservletrequest.getParameter("CHK_INSUMO"):"N";
            String s12 = (httpservletrequest.getParameter("CHK_SOFT_CARGO")!=null)?httpservletrequest.getParameter("CHK_SOFT_CARGO"):"N";
            String s13 = (httpservletrequest.getParameter("CHK_RECLAMO")!=null)?httpservletrequest.getParameter("CHK_RECLAMO"):"N";           

            String s14 = httpservletrequest.getParameter("txtI");
            String s15 = httpservletrequest.getParameter("selArea");
            String s16 = httpservletrequest.getParameter("txtIII");
            String s17 = httpservletrequest.getParameter("txtIV");
            String s18 = httpservletrequest.getParameter("txtV");
            String s19 = httpservletrequest.getParameter("ListaDistrubucion");
            ...
            if(i >= 0)
            {
                s = "delete from gdc.no_conformidad where id = " + s3;
                i = ADatos.ModificaDB(s);
                printwriter.println("<BR>SQL=" + s);
                printwriter.println("<BR>nroreg=" + i);
            }
            ...
            for (i=0;i<totalFil;i++){
            	...
            	for (j=0;j<totalCol;j++){
            		if (h<rs.size()  ) {
            			String sChecked = "";
            			if ((s6.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_REAL"))
            					|| (s7.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_POTENCIAL")) 
            					|| (s8.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_PROVEEDOR")) 
            					|| (s9.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_PROCESO")) 
            					|| (s10.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_PRODUCTO")) 
            					|| (s11.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_INSUMO")) 
            					|| (s12.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_SOFT_CARGO")) 
            					|| (s13.toString().compareTo("S")==0 && ((String)rs.elementAt(h)).equals("CHK_RECLAMO")) )
            				sChecked = "Checked";            			
            ...
            s2 = s2 + "<tr><td class='textogral' width='5%' valign='top'>&#32</td><td class='textogral' width='95%' valign='top'>" + s14 + "</td><tr>";
            ...
            s = "select descripcion from gdc.procesos where sigla ='" + s15 + "'";
            ...
            s2 = s2 + "<tr><td class='textogral' width='5%' valign='top'>&#32</td><td class='textogral' valign='top'>" + s18 + "</td></tr>";
            s2 = s2 + "</table>";
            s2 = s2 + "</td></tr>";
            ...
            String s21 = "";
            StringTokenizer stringtokenizer = new StringTokenizer(s19, ",");
            do
            {
                if(!stringtokenizer.hasMoreTokens())
                    break;
                String s20 = stringtokenizer.nextToken();
                String s1 = "select mail from sgc.usuarios where login ='" + s20 + "'";
                j = ADatos.ConsultaDB(s1);
                rs = new Vector();
                rs = ADatos.getResult();
                if(rs.size() > 0)
                    if(s21.length() > 0)
                        s21 = s21 + "," + (String)rs.elementAt(0);
                    else
                        s21 = (String)rs.elementAt(0);
            } while(true);
            EnvMail.Envio(s21, "SERAPIS. No Conformidad", s2);
