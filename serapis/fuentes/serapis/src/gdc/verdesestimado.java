    ...
    void PreparaPublica(PrintWriter printwriter, int i)
    {
        ...
        try
        {
            ...
            if(j == 1)
            {
                ...
                if(TipoDespliegue.compareTo("N") != 0)
                {
                    s15 = (String)rsfile.elementAt(11);
                    Integer integer1 = (Integer)rsfile.elementAt(12);
                    String s17 = (String)rsfile.elementAt(13);
                } else
                {
                    s15 = s11;
                    Integer integer2 = new Integer(0);
                    String s18 = "";
                    integer3 = (Integer)rsfile.elementAt(14);
                }
                //CopiadorDeArchivos _tmp = ACopia;
                CopiadorDeArchivos.copia(RutaDocumentos + RutaBase + s5 + "\\" + s15, RutaSitio + "WEB-INF\\downloadroot\\" + s11);
                DireccionArchivo = RutaDocumentos + RutaBase + s5 + "\\" + s15;
